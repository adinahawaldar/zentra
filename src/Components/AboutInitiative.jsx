    ...
    <section className="bg-white px-4 py-16 md:py-20 lg:py-24">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          {/* Vision */}
          <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm transition-all hover:border-emerald-300">
          ...
          <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm transition-all hover:border-emerald-300">
            ...
            <div className="mt-4 grid grid-cols-2 gap-2 text-xs">
              <div className="flex items-center gap-1.5">
                <span className="font-mono text-emerald-700">14</span>
                <span className="text-slate-600">active clusters</span>
              </div>
              <div className="flex items-center gap-1.5">
                <span className="font-mono text-emerald-700">2030</span>
                <span className="text-slate-600">50‑cluster target</span>
              </div>
            </div>
          </div>
        </div>

        {/* Founder narrative - Adina Hawaldar */}
        <div className="mt-10 rounded-lg border-l-4 border-emerald-700 bg-slate-50 p-6 md:p-8">
          <div className="grid gap-6 md:grid-cols-12">
            <div className="md:col-span-3">
              <div className="flex items-center gap-3">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-emerald-200/80">
                  <span className="font-serif text-lg font-semibold text-emerald-900">AH</span>
                </div>
                <div>
            ...
            <div className="md:col-span-9">
              <p className="text-sm italic leading-relaxed text-slate-800 md:text-base">
                ...
                changed. Energy was still being wasted at staggering scale. Communities
                were still locked out of the solutions being built around them.
              </p>
              <p className="mt-3 text-sm italic leading-relaxed text-slate-800 md:text-base">
                The technology exists. The financing exists. What's missing is a model that
                connects them—and puts communities in control. That's what we're building."
              </p>
              <div className="mt-4 flex items-center gap-4 text-xs">
                <span className="text-slate-600">— Adina Hawaldar</span>
        ...
        <div className="mt-16">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {coreValues.map((value) => (
              <div
                key={value.id}
                className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm transition-all hover:border-emerald-300"
              >
                <div className="flex h-8 w-8 items-center justify-center rounded-md bg-emerald-50">
                  {value.icon}
                </div>
                <h4 className="mt-4 text-sm font-semibold text-slate-900">{value.title}</h4>
        ...
        {/* Timeline / Milestones */}
        <div className="mt-16 rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-4">
            {milestones.map((milestone, index) => (
              <div key={index} className="relative">
                ...
                <h4 className="mt-2 text-sm font-semibold text-slate-900">{milestone.title}</h4>
                <p className="mt-1 text-xs text-slate-700">{milestone.description}</p>
              </div>
            ))}
          </div>
        </div>

        {/* Why this exists - concise */}
        <div className="mt-12 rounded-lg bg-emerald-50/80 p-6">
          <div className="flex items-start gap-4">
            <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-emerald-200/70">
              <svg
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-relaxed text-slate-800">
                ...
                wasted. Communities wait for solutions that never arrive. The gap between 
                what we know and what we do has grown into a chasm. Zentra is not another 
                study, another pledge, another report. It is the thing itself—infrastructure 
        ...
        <div className="mt-12 flex flex-wrap items-center justify-between gap-4 border-t border-slate-200 pt-8">
          <div className="flex items-center gap-2 text-xs text-slate-600">
            ...
            <span>Research partners: MIT Urban Systems Lab, Stanford Sustainable Systems Lab</span>
          </div>
          <div className="flex items-center gap-2 text-xs text-slate-600">
            <span className="font-medium">Founded 2024</span>
            <span className="h-3 w-px bg-slate-300" />
            <span>501(c)(3) fiscal sponsorship</span>
          </div>
        </div>

        {/* Attribution */}
        <div className="mt-8 text-center text-[10px] text-slate-500">
          <p>A public‑private initiative • Fully audited • Committed to radical transparency</p>
        </div>
      </div>
    </section>
  );
